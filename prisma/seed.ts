import { Locale, ProjectStatus, WebsiteStatus } from '../src/generated/prisma';
import { db } from '../src/server/db.script';
import { solisProject, solisWebsite } from './solis-data';
      ...
      create: [
        {
          ...
          descriptionShort: 'Rychlé sestavení konverzních stránek s důrazem na výkon a SEO.',
      ...
      create: [
        {
          ...
          descriptionShort: 'Nástroj pro řízení projektů a kapacit v rychle rostoucích firmách.',
        ...
        },
        {
          ...
          descriptionShort: 'A tool for managing projects and capacity in fast-growing teams.',
      ...
      create: [
        {
          ...
          descriptionShort: 'Aplikace, která propojuje denní rituály a data o náladě.',
        ...
        },
        {
          ...
          descriptionShort: 'An app that connects daily rituals with mood insights.',
      ...
      create: [
        {
          ...
          descriptionShort: 'Analytická platforma pro investory s důrazem na lokalitu.',
        ...
        },
        {
          ...
          descriptionShort: 'Analytics platform for investors with location-first insights.',
      ...
      create: [
        {
          ...
          descriptionShort: 'Sada šablon a procesů pro rychlý launch firemních webů.',
        ...
        },
        {
          ...
          descriptionShort: 'A set of templates and workflows to launch business sites fast.',
